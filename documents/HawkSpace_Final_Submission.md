...
| Scrum Master      | Efetobore Salubi    | Sprint facilitation, backlog flow, GitHub coordination |
...
|                   | Muqadas Nazif       | Accessibility, release packaging, QA                   |
...
![Login screen – HawkSpace Laurier email sign-in](images/login-auth.png)

![Logged-in header with profile and navigation](images/login-logged-in-header.png)

![Search Availability screen with filters and slot timeline](images/student-search-availability.png)

![Request Booking success card with tracking ID](images/student-request-booking-single-success.png)

![Recurring booking wizard with conflict warning and timeline](images/student-request-booking-recurring.png)

![My Requests list showing statuses and admin notes](images/student-my-requests.png)

![Events page with curated campus events](images/student-browse-events.png)

![Admin Pending Requests queue with conflict calendar](images/admin-requests-queue-conflict.png)

![Admin override action with override completed history and room calendar](images/admin-override-history.png)

![Admin Monthly Usage Report with CSV export button](images/admin-reports-csv.png)

![High-contrast accessibility mode on the main search page](images/accessibility-high-contrast.png)

![Email verification message for HawkSpace account](images/verify-account-email.png)

![Reset password email for HawkSpace account](images/reset-password-account.png)
